...
use case_study;
select khach_hang.ho_ten,dich_vu.id_dich_vu,dich_vu.ten_dich_vu,dich_vu.dien_tich,dich_vu.so_nguoi_toi_da,dich_vu.chi_phi_thue,loai_dich_vu.ten_loai_dich_vu,month(hop_dong.ngay_lam_hop_dong), count(dich_vu.id_dich_vu) as 'so luong khach dat phong tung thang'
from dich_vu
