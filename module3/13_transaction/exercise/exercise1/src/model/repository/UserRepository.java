...
public class UserRepository {
    ...
    public List<User>selectAllCallable(){
        List<User> users = new ArrayList<>();
    ...
    public boolean deleteCallable(int id) throws SQLException{
        boolean rowDeleted;
    ...
    public boolean updateCallable(User user) throws SQLException{
        boolean rowUpdated;
        String query="{CALL update_user(?,?,?,?)}";
        try (Connection connection = baseRepository.connectDataBase(); CallableStatement callableStatement = connection.prepareCall(query);) {
