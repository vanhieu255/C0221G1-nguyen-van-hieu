            ...
            <table class="table table-success table-striped table-bordered" id="tableCustomer">
                ...
                <c:forEach var="employee" items="${employees}" varStatus="status">
                    <tr>
                        ...
                        <td><a href="/employees?action=edit&id=${employee.idEmployee}" class="btn btn-success btn-sm">Sửa</a>
                        </td>
                        <td>
                            <button type="button" class="btn btn-danger btn-sm"
                                    onclick="sendDataToModal('${employee.idEmployee}')" data-bs-toggle="modal"
