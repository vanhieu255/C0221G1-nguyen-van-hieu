...
use case_study;
select nhan_vien.id_nhan_vien,nhan_vien.ho_ten,trinh_do.trinhdo,bo_phan.ten_bo_phan,nhan_vien.sdt,nhan_vien.dia_chi,hop_dong.id_hop_dong,hop_dong.ngay_lam_hop_dong,count(nhan_vien.id_nhan_vien) as'so luong hop dong kiem duoc'
from nhan_vien
